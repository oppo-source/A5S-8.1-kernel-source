...
#ifdef VENDOR_EDIT
#Bin.Li@BSP.Fingerprint.Basic, 2017/08/15, modify for img sign
    ifneq ($(filter full_oppo6762_18361 full_oppo6765_18121 full_oppo6765_18511 full_oppo6765_18510, $(TARGET_PRODUCT)),)
	$(srctree)/../build/tools/Sign_Client/signature_client_18361 --project=18361 --input_path=$(DRVGEN_OUT)/ --input_name=odmdtbo.img --output_path=$(DRVGEN_OUT)/signed/
		cp $(DRVGEN_OUT)/signed/odmdtbo.img $(DRVGEN_OUT)/odmdtbo.img
    endif
#endif /*VENDOR_EDIT*/
.PHONY: odmdtboimage
