...
** ODM_WT_EDIT
** File: - trigger_panic.c
** Description: Source file for trigger panic.
**           To trigger panic,you can first press vol-,then press vol+ and delay 2s+,
	     then press powerkey,the device will enter into dump.
** Version: 1.0
** Date : 2018/10/29   
** Author: Haibin1.zhang@ODM_WT.BSP.Kernel.Stability
**
** ------------------------------- Revision History: -------------------------------
**  <author>                <date>     <version >          <desc>
**  Haibin1.zhang       2018/10/29     1.0     build this module
****************************************************************/
