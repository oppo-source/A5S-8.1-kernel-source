        ...
        unsigned long arg)
{
    ...
    case P61_SET_PWR:
        ...
        else if (arg == 1)
        {
			...
			P61_DBG_MSG(KERN_ALERT "p61_dev_ioctl P61_SET_PWR ret %d \n", ret);
            msleep(50);
            gpio_set_value(p61_dev->rst_gpio, 1);
            msleep(20);
    ...
    case P61_SET_DWNLD_STATUS:
        ...
        P61_DBG_MSG(KERN_ALERT " P61_SET_DWNLD_STATUS: =%ld exit",arg);
    break;
        ...
        loff_t *offset)
{
    ...
    P61_DBG_MSG(KERN_ALERT "p61_dev_write -Enter count %ld\n", count);
        ...
        loff_t *offset)
{
    ...
    P61_DBG_MSG("p61_dev_read count %ld - Enter \n", count);
    ...
    if (p61_dev->enable_poll_mode)
    {
        ...
        P61_DBG_MSG(KERN_INFO"SPI_READ returned 0x%lx", count);
        ret = spi_read(p61_dev->spi, (void *)&rx_buffer[0], count);
		P61_DBG_MSG("p61_dev_read  spi_read nnnn %d \n", ret);
        if (0 > ret)
        {
    ...
    P61_DBG_MSG(KERN_INFO"total_count = %ld", count);
