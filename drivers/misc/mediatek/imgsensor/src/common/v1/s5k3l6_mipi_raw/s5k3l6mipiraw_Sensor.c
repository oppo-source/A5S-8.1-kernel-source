...
#define ENABLE_S5K3L6_OTP 1
//#define __ENABLE_VIDEO_CUSTOM_PDAF__  //tao.li@Camera.Driver 2019/01/22 Disable video and custom PDAF feature
...
//wingtech.malp add for wifi desense begin
#if 0
	.isp_driving_current = ISP_DRIVING_8MA, //mclk driving current
#else
	.isp_driving_current = ISP_DRIVING_4MA, //mclk driving current
#endif
//wingtech.malp add for wifi desense end
	...
	.mclk = 24,//mclk value, suggest 24 or 26 for 24Mhz or 26Mhz //modified by chenshiqiang.wt for rf desense on 20180620
 ...
 //for 3l6 4208x2368
{
	 ...
	 .i4SubBlkW =16,
	 .i4SubBlkH =16,
	 .i4PosL = {{28,39},{44,43},{64,43},{80,39},{32,59},{48,63},{60,63},{76,59},{32,75},{48,71},{60,71},{76,75},{28,95},{44,91},{64,91},{80,95}},
	 .i4PosR = {{28,43},{44,47},{64,47},{80,43},{32,55},{48,59},{60,59},{76,55},{32,79},{48,75},{60,75},{76,79},{28,91},{44,87},{64,87},{80,91}},
	 .i4BlockNumX = 65,
	 .i4BlockNumY = 36,
	 /* 0:IMAGE_NORMAL,1:IMAGE_H_MIRROR,2:IMAGE_V_MIRROR,3:IMAGE_HV_MIRROR */
	 .iMirrorFlip = 0,
...
static struct stCAM_CAL_CHECKSUM_STRUCT s5k3l6Checksum[7] =
{
	...
	{PDAF_ITEM,0x0780,0x0780,0x0CFC,0x0CFD,0x55},
	{TOTAL_ITEM,0x0000,0x0000,0x0CFD,0x0CFE,0x55},
...
{
	kal_uint16 res0 = read_cmos_sensor_byte(0x0000);
	kal_uint16 res1 = read_cmos_sensor_byte(0x0001);
	LOG_INF("[3l6]res0 = 0x%x,[3l6]res1 = 0x%x\n", res0,res1);
...
/* Xuegui.Bao@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
	...
	LOG_INF("S5K3L6_I2CBUS = %d, I2C_bus = %d\n", S5K3L6_I2CBUS, I2C_bus);
	if (I2C_bus != S5K3L6_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		pr_err("S5K3L6_I2CBUS: %d, I2C_bus = %d, Check Error!\n", S5K3L6_I2CBUS, I2C_bus);
...
/* Xuegui.Bao@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_S5K3L6_OTP
		size = imgSensorReadEepromData(&sensor_eeprom_data, s5k3l6Checksum);
