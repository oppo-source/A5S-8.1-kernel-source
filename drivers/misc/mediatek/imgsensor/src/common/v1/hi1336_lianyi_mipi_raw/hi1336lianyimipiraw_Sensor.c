...
#include "hi1336lianyimipiraw_Sensor.h"
...
#define ENABLE_HI1336_LIANYI_OTP 1
//#define LONG_EXPOSURE

#define PFX "hi1336_lianyi_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI1336_LIANYI_SENSOR_ID,
	...
	.i2c_addr_table = {0x40, 0xff},// {0x42, 0xff},{0x46, 0xff},
	.i2c_speed = 400,
};
...
#ifdef ENABLE_HI1336_LIANYI_OTP
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= HI1336_LIANYI_SENSOR_ID,
	.deviceID = 1,
	.dataLength = 0x0CDF,
...
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
	...
	LOG_INF("HI1336_I2CBUS = %d, I2C_bus = %d\n", HI1336_I2CBUS, I2C_bus);
	if (I2C_bus != HI1336_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		pr_err("HI1336_I2CBUS: %d, I2C_bus = %d, Check Error!\n", HI1336_I2CBUS, I2C_bus);
		...
		do {
		    *sensor_id = return_sensor_id();
		    if (*sensor_id == imgsensor_info.sensor_id) {
		        hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "lianyi");
/* Junwei.Ma@Camera.Driver, 2018/10/10, add for [summer otp bringup] */
#ifdef ENABLE_HI1336_LIANYI_OTP
