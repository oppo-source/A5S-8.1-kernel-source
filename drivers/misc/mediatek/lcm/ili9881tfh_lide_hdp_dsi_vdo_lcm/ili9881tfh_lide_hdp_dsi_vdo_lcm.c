...
** ODM_WT_EDIT
** File: - ili9881tfh_lide_hdp_dsi_vdo_lcm.c
** Description: source file for lcm ili9881tfh+lide in kernel stage
**
** Version: 1.0
** Date : 2018/12/03
...
**  houbenzhong       2018/12/03    1.0     source file for lcm ili9881tfh+lide in kernel stage
**
****************************************************************/
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0xD6,0x01,{0x87}},     //FTE=TSHD, FTE1=TSHD
	{0x27,0x01,{0x20}},     //VFP
	{0x28,0x01,{0x20}},     //VBP
	...
	{0xC7,0x01,{0x05}},    //1 bit ESD

	{0xDD,0x01,{0x10}},    //mipi 3 lane

	{0xFF,0x03,{0x98,0x81,0x07}},
	{0x0F,0x01,{0x02}},  //TP_term_GVDD_on //0525
	{0xFF,0x03,{0x98,0x81,0x08}},
	{0xE0,0x1B,{0x00,0x24,0x5A,0x86,0xC0,0x54,0xF7,0x29,0x56,0x7D,0xA5,0xBE,0xF3,0x24,0x53,0xEA,0x84,0xBE,0xE3,0x12,0xFF,0x38,0x69,0xA5,0xD0,0x03,0xFF}},
	{0xE1,0x1B,{0x00,0x24,0x5A,0x86,0xC0,0x54,0xF7,0x29,0x56,0x7D,0xA5,0xBE,0xF3,0x24,0x53,0xEA,0x84,0xBE,0xE3,0x12,0xFF,0x38,0x69,0xA5,0xD0,0x03,0xFF}},
...
//Bin.Su@ODM_WT.BSP.TP.Timing.2018/11/01,Adjust TP timing in suspend and resume status
	...
	if (lcm_dsi_mode == CMD_MODE) {
		...
		pr_debug("ili9881tfh_lide_lcm_mode = cmd mode :%d----\n", lcm_dsi_mode);
	} else {
		push_table(NULL, init_setting_vdo, sizeof(init_setting_vdo) / sizeof(struct LCM_setting_table), 1);
		pr_debug("ili9881tfh_lide_lcm_mode = vdo mode :%d----\n", lcm_dsi_mode);
	}
}
...
{
	pr_debug("[lcd] ili9881tfh_lide_cabc_mode is %d \n", level);
	if (level) {
...
{
	pr_debug("ili9881tfh_lide backlight_level = %d\n", level);
...
static unsigned int lcm_esd_recover(void)
{
	...
	if (lcm_dsi_mode == CMD_MODE) {
		push_table(NULL, init_setting_cmd, sizeof(init_setting_cmd) / sizeof(struct LCM_setting_table), 1);
		pr_debug("ili9881tfh_lide_lcm_mode = cmd mode esd recovery :%d----\n", lcm_dsi_mode);
	} else {
		push_table(NULL, init_setting_vdo, sizeof(init_setting_vdo) / sizeof(struct LCM_setting_table), 1);
		pr_debug("ili9881tfh_lide_lcm_mode = vdo mode esd recovery :%d----\n", lcm_dsi_mode);
	}
...
struct LCM_DRIVER ili9881tfh_lide_hdp_dsi_vdo_lcm_drv = {
	.name = "ili9881tfh_lide_hdp_dsi_vdo_lcm_drv",
