...
static int silfp_probe(struct spi_device *spi)
{
    ...
    LOG_MSG_DEBUG(DBG_LOG, "[%s] enter1111.\n", __func__);
	...
	LOG_MSG_DEBUG(DBG_LOG, "[%s] exit1111.\n", __func__);
	//silfp_resource_init(fp_dev,&silfp_dev_init_d);//TODO TEST remove it
    return status;
