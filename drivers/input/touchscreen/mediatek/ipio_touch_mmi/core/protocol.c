...
//Bin.Su@ODM_WT.BSP.TP.FUNCTION.2018/12/10, add ear phone function
	insert_func(15, protocol->func_ctrl_len, protocol->ear_phone_ctrl, "ear_phone_ctrl");
#endif
...
#ifdef ODM_WT_EDIT
//Bin.Su@ODM_WT.BSP.TP.FUNCTION.2018/12/10, add ear phone function
		protocol->ear_phone_ctrl[0] = 0x1;
		protocol->ear_phone_ctrl[1] = 0x16;
		protocol->ear_phone_ctrl[2] = 0x0;
#endif
