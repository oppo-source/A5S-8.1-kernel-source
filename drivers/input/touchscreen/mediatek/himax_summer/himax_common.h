...
#define HIMAX_DRIVER_VER "1.3.0.11_OPPO_WINTECH_0C"
...
struct himax_ts_data {
	...
	struct mutex resume_update_fw_lock;//wdd add
...
/******* SPI-end *******/
	...
	struct work_struct resume_work_queue;//wdd add
