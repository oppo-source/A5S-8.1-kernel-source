...
#define NOTCH_RX_START	35
#define NOTCH_RX_END		36
#define NOTCH_TX_START	9
#define NOTCH_TX_END		10
...
char *g_hx_inspt_crtra_name[] = {
	...
	"CRITERIA_NOISE",
	"CRITERIA_NOISE_SUM_MAX",
	"CRITERIA_NOISE_F1_SUM_MAX",
	"CRITERIA_SORT_MIN",
	"CRITERIA_SORT_MAX",
