...
static int get_test_threshold_incell(void)
{
    ...
    fts_init_buffer(thr->lpwg_rawdata_max, thr->basic.lpwg_rawdata_max, node_num);
    fts_init_buffer(thr->lpwg_rawdata_min, thr->basic.lpwg_rawdata_min, node_num);
...
//    FTS_TEST_DBG("rawdata2_max:%d", thr->basic.rawdata2_max);
    ...
    FTS_TEST_DBG("lpwg_rawdata_min:%d", thr->basic.lpwg_rawdata_min);
    FTS_TEST_DBG("lpwg_rawdata_max:%d", thr->basic.lpwg_rawdata_max);
    FTS_TEST_DBG("lpwg_lcdnoise_frame:%d", thr->basic.lpwg_lcdnoise_frame);
    FTS_TEST_DBG("lpwg_lcdnoise_coefficient:%d", thr->basic.lpwg_lcdnoise_coefficient);
    FTS_TEST_DBG("lpwg_lcdnoise_coefficient_vkey:%d", thr->basic.lpwg_lcdnoise_coefficient_vkey);
    ...
    print_buffer(thr->lpwg_rawdata_min, tdata->node.node_num, tdata->node.rx_num);
    print_buffer(thr->lpwg_rawdata_max, tdata->node.node_num, tdata->node.rx_num);
}
