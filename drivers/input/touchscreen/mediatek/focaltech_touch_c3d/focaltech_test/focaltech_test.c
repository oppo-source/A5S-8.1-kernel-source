...
//+bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
...
static int fts_test_entry(char *ini_file_name)
{
    ...
    if (true == fts_test_start()) {
		test_result = 1;//bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
		printk("ttt test pass\n");
        FTS_TEST_SAVE_INFO("\n=======Tp test pass. \n\n");
    } else {
    	test_result = 0;//bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
    ...
    FTS_TEST_FUNC_EXIT();
	return test_result; //bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
...
#if 1//+bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
...
#endif //-bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
int fts_test_init(struct i2c_client *client)
{
    int ret = 0;
	printk("ttt fts_test_init\n");
    FTS_TEST_FUNC_ENTER();
#if 0 //+bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
...
int fts_test_exit(struct i2c_client *client)
{
   ...
   // sysfs_remove_group(&client->dev.kobj, &fts_test_attribute_group);//bug 333216 add by tangruiliang.wt for tp open short test in factory  20180118
