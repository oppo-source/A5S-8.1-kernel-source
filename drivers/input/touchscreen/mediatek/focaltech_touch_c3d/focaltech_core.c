...
//+bug 335611 add by tangruiliang.wt for tp info in factory mode  20180118
...
#if FTS_GESTURE_EN
	if (gesture_data.gesture_all_switch)//bug342811 add by tangruiliang.wt for gesture  function start 20180228
...
//+ bug 354726 add by tangruiliang.wt for tp info in factory mode  20180514
...
//	hardwareinfo_tp_register(hardwareinfo_set, &fts_data);//bug 335611 add by tangruiliang.wt for tp info in factory mode  20180118
...
if (gesture_data.gesture_all_switch){//bug342811 add by tangruiliang.wt for gesture  function start 20180228
    ...
    fts_power_suspend();
#endif
	//+bug342811 add by tangruiliang.wt for gesture  function start 20180228
	...
	//-bug342811 add by tangruiliang.wt for gesture  function end 20180228
...
#if FTS_GESTURE_EN
	if (gesture_data.gesture_all_switch || fts_gesture_data.active){ //bug342811 add by tangruiliang.wt for gesture  function  20180228
