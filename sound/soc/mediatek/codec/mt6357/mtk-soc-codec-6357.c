...
#ifndef ODM_WT_EDIT
//Gong.Chen@ODM_WT.mm.audiodriver.Machine, 2018/11/20, Modify for headset pop nosie
...
#ifndef ODM_WT_EDIT
//Gong.Chen@ODM_WT.mm.audiodriver.Machine.1673576, 2018/12/03, Add for setting micbias0 2.5V
...
#define SPK_WARM_UP_TIME        (25)	/* unit is ms */
	if (enable) {
		...
		#ifndef ODM_WT_EDIT
		//Gong.Chen@ODM_WT.mm.audiodriver.Machine, 2018/11/07, Add for speaker pa timing
...
//Gong.Chen@ODM_WT.mm.audiodriver.Machine.1673576, 2018/12/03, Add for setting micbias0 2.5V
		...
		if (GetAdcStatus() == false) {
			...
			if (mCodec_data->mAudio_Ana_Mux
				...
				/* headset mic */
#ifdef VENDOR_EDIT
				/* Yongzhi.Zhang@PSW.MM.AudioDriver.Codec.1309324, 2018/10/26,
				 * modify for changing micbias vol to 2.7V for headset mic not recording */
				Ana_Set_Reg(AUDENC_ANA_CON9, 0x0071, 0x00ff);
#endif /* VENDOR_EDIT */
				/* Disable MICBIAS1 */
...
#ifdef VENDOR_EDIT
	/* Yongzhi.Zhang@PSW.MM.AudioDriver.Codec, 2018/10/26,
